...
public class ParticleGridGeneratorHDRPPBRFloor : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        ...
        ps.GetComponent<Renderer>().material.SetVector("_OffsetVector", this.gameObject.transform.up);
    }
}
